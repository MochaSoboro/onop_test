...
class NSOuter {
	...
	static void meth_s4() {
		System.out.println("외부 static meth_s4()");
	}
	...
	static class NSInner {
		...
		void meth_1() {
			System.out.println("스태틱 내부 meth_1()------------ 시작");
			// 인스턴스 메소드 일지라도 외부의 static만 가능
...
//			System.out.println(NSOuter.this.a+", "+NSOuter.this.b);
			...
			meth_4();
			meth_s4();
			System.out.println("스태틱 내부 meth_1()------------ 끝");
		}
		void meth_4() {
			System.out.println("스태틱 내부 meth_4()");
		}
		static void meth_s1() {
			System.out.println("스태틱 내부 static meth_s1() 시작 ------------------------");
			// 외부의 static만 가능
//			System.out.println(NSOuter.this);
//			System.out.println(NSOuter.this.a+", "+NSOuter.this.b);
...
//			meth_4();
			meth_s4();
			System.out.println("스태틱 내부 static meth_s1() 끝 ------------------------");
		}
		static void meth_s4() {
			System.out.println("스태틱 내부 static meth_s4()");
		}
...
//		NSOuter.NSInner.meth_4();
		...
		System.out.println("oo1.mm1: "+oo1.mm1);
		System.out.println("oo1.mm1: "+oo1.mm1.c+", "+oo1.mm1.b);
		System.out.println("oo1.mm1: "+oo1.mm1.sc+", "+oo1.mm1.sb);
		oo1.mm1.meth_1();
		oo1.mm1.meth_4();
		oo1.mm1.meth_s1();
		oo1.mm1.meth_s4();
		System.out.println("oo2: "+oo2);
		System.out.println("oo2.mm1: "+oo2.mm1);
		System.out.println("oo2.mm1: "+oo2.mm1);
		System.out.println("oo2.mm1: "+oo2.mm1.c+", "+oo2.mm1.b);
		System.out.println("oo2.mm1: "+oo2.mm1.sc+", "+oo2.mm1.sb);
		oo2.mm1.meth_1();
		oo2.mm1.meth_4();
		oo2.mm1.meth_s1();
		oo2.mm1.meth_s4();
...
//		NSOuter.NSInner ns3 = oo1.new NSInner("ns_c1", 9988);
