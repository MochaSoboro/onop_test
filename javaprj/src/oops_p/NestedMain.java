...
class NNOuter{
	...
	void meth_1() {
		System.out.println("외부 meth_1(): "+name+", "+age+", "+mm1);
		System.out.println(mm1.name+", "+mm1.bb);
		System.out.println(mm1.sa+", "+mm1.sb);
		mm1.meth_2();
		mm1.meth_3();
		System.out.println("외부 meth_1() ------------------------");
	}
	void meth_2() {
...
//		System.out.println(mm1.name+", "+mm1.bb);
		...
		// mm1은 인스턴스 변수이므로 접근 불가
//		System.out.println(mm1.sa+", "+mm1.sb);
//		System.out.println(mm1);
		
		// 클래스로 직접 접근하여 static 접근 가능
...
//			System.out.println("외부: "+super.name+", "+age);
		...
		static void meth_s2() {
			System.out.println("InnMM.static meth_s2()");
		}
		static void meth_s3() {
			System.out.println("InnMM.static meth_s3()");
		}
	...
	// 멤버 변수 = 멤버 이너 인스턴스 클래스 생성
	InnMM mm1 = new InnMM("서태웅", 17);
	// 스태틱 멤버 변수로 일반 이너클래스 사용 불가 - 스태틱 이너클래스만 가능
...
//		System.out.println("oo1.mm1: "+oo1.mm1.age);	외부인스턴스멤버 접근 불가
		...
		System.out.println("oo1 static: "+oo1.sa+", "+oo1.sb);
		System.out.println("oo1.mm1 static: "+oo1.mm1.sa+", "+oo1.mm1.sb);
//		System.out.println("oo1.InnMM static: "+oo1.InnMM.sa+", "+oo1.InnMM.sb);
//		System.out.println("InnMM static: "+InnMM.sa+", "+InnMM.sb);
		// 외부에서 이너클래스의 스태틱 접근 방법 : (아우터클래스).(이너클래스).(스태틱요소)
		System.out.println("NNOuter.InnMM static: "+NNOuter.InnMM.sa+", "+NNOuter.InnMM.sb);
