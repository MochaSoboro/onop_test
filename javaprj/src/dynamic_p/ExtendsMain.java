...
class Uncle {}
class ExChild1 extends ExPar {	// ExPar, Uncle 다중 상속 불가
	String c = "자식1c";
	int d = 400;
	
	void meth_3() {
		System.out.println("자식 meth_3() 실행 : "+c+", "+d);
		// 형제 변수 가져다 쓸 수 없음
//		System.out.println("자식 meth_3() 실행 : "+e+", "+d);
	}
	void meth_4() {
...
class ExChild2 extends ExPar {
	...
	void meth_5() {
		// 형제 변수 가져다 쓸 수 없음
//		System.out.println("자식 meth_5() 실행 : "+c+", "+d);
		System.out.println("자식 meth_5() 실행 : "+e+", "+d);
	}
	void meth_4() {
		System.out.println("자식 meth_4() 실행");
	}
