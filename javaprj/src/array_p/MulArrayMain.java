...
//				"나루토"
		...
		System.out.println(arr1);	// [[Ljava.lang.String;@28a418fc
		
		System.out.println("arr1[0] : " + arr1[0] + " : " + Arrays.toString(arr1[0]));	// [Ljava.lang.String;@5305068a
		...
		System.out.println("arr1[1][1] : " + arr1[1][1]);	// null
		
		System.out.println(arr1[2] == arr2);	// true
		System.out.println(arr1[3] == arr3[1]);	// true
