...
public class StringMain {
	...
	public static void main(String[] args) {
		String tt1 = "아기상어";	// "아기상어"가 인스턴스로 생성되어 tt1은 아기상어의 주소를 받음
		String tt2 = "아기상어";
		...
		System.out.println("tt3 == \"아기상어\" : "+(tt3 == "아기상어"));		// false
		System.out.println("tt4 == \"아기상어\" : "+(tt4 == "아기상어"));		// false
		...
		// 문자열은 Object 클래스를 상속 받아서 처리한 인스턴스
