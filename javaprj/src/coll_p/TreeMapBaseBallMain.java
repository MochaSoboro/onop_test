...
public class TreeMapBaseBallMain {
	...
	public static void main(String[] args) {
		String [] hit = ("h1,h3,h5,a2,a3,a4,h7,h8,a7,a9,h2,a2,a3,"+
						"h3,a4,a7,h5,a8,h3,h3,a2,a4,h5,a7,h5,k6").split(",");
...
//			Map.Entry<Character, TreeMap<Character, Integer>> team = (Map.Entry)obj;
			System.out.println(team.getKey()+">>>>>");
			
//			for (Object oo : ((TreeMap)team.getValue()).entrySet()) {
			for (Map.Entry<Character, Integer> player : team.getValue().entrySet()) {
//				Map.Entry<Character, Integer> player = (Map.Entry)oo;
