...
public class GenericsMain {
	...
	public static void main(String[] args) {
		GenAAA a1 = new GenAAA();	// generic을 명시하지 않을 경우 Object 타입
		a1.a = "아기상어";
		a1.b = "엄마상어";
		...
		int c = (int)a2.b;	// a2.b는 Object이므로 형변환이 필요
		a2.b = false;
		System.out.println(a2);
		a2.meth_1(333, 444);
		a2.meth_1(555, "나는 고래");
		System.out.println("a3-----------------");
		GenAAA a3 = new GenAAA<Integer, Integer>("서태웅", 666);	// 생성시 generic 지정 -> 생성자에만 영향을 미침
		System.out.println(a3);
...
//		a5.b = "성현준";	선언시 지정한 generic으로 대입
		a5.b = 777;
		c = a5.b;	// generic으로 지정되어 형변환이 필요 없음
//		a5.meth_1(888, 999);
		a5.meth_1(123, true);
	}
