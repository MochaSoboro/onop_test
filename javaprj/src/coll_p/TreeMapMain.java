...
public class TreeMapMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("mm1 "+mm1);	// 순서 없음
		System.out.println("mm2 "+mm2);	// 입력 순서
		System.out.println("mm3 "+mm3);	// 키 순서
...
//		mm2.getFirst();	LinkedHashSet처럼 getFirst() 없음
		...
		et = mm3.lowerEntry(33);	// key가 33 미포함 바로 아래
		...
		et = mm3.higherEntry(33);	// key가 33 미포함 바로 위
		...
		et = mm3.floorEntry(33);	// key가 33 포함 바로 아래
		...
		et = mm3.ceilingEntry(33);	// key가 33 포함 바로 위
		...
		System.out.println("pollLarstEntry: "+et);
		System.out.println("mm3: "+mm3);
		
		NavigableMap mm4 = mm3.descendingMap();	// 역순
		System.out.println("descendingMap: "+mm4);
		NavigableSet ss = mm3.descendingKeySet();
		System.out.println("descendingKeySet: "+ss);
		
		SortedMap mm5 = mm3.headMap(55);	// 주어진 key보다 낮은 entry를 리턴
		...
		mm5 = mm3.tailMap(55);	// 주어진 key보다 높은 entry를 리턴
		...
		System.out.println("subMap(33, true, 66, false) "+mm5);
		mm5 = mm3.subMap(33, false, 66, true);
		System.out.println("subMap(33, false, 66, true) "+mm5);
