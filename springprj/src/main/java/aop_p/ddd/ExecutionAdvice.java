...
public class ExecutionAdvice {
	...
	void dog(JoinPoint joinPoint) {
		System.out.println("메소드 dog로 시작: "+joinPoint.toShortString());
	}
	...
	void movie(JoinPoint joinPoint) {
		System.out.println("패키지 aop_p.movie: "+joinPoint.toShortString());
	}
	
	void movieSub(JoinPoint joinPoint) {
		System.out.println("패키지 aop_p.movie 하위: "+joinPoint.toShortString());
	}
