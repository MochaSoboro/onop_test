...
public interface ExamMapper {
	...
	@Select("SELECT * FROM exam order by id desc limit #{start}, #{limit}")
	...
	@Insert("<script>"
			+ "INSERT INTO exam (hakgi, name, pid, kor, eng, mat, pw, reg_date) "
			+ "VALUES "
	...
	@Insert("INSERT INTO exam (id, hakgi, name, pid, kor, eng, mat, pw, ff, reg_date) "
			+ "VALUES (#{id}, #{hakgi}, #{name}, #{pid}, #{kor}, #{eng}, #{mat}, #{pw}, #{ff}, now())")
